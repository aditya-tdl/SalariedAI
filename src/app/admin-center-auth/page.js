...
export default function AdminLoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            dispatch(openSnackbar({ message: "Login Successful! Welcome back.", severity: "success" }));
            router.push("/admin");
        } catch (err) {
        ...
        >
            ...
            >
                <Box sx={{ mb: 4, textAlign: "center" }}>
                    ...
                    <Typography variant="h4" fontWeight="800" sx={{ color: "#1B2559", mb: 1, letterSpacing: "-1px" }}>
                        Admin Portal
                    </Typography>
                ...
                <form onSubmit={handleSubmit}>
                    <Box sx={{ mb: 3 }}>
                        <Typography variant="body2" sx={{ color: "#1B2559", fontWeight: "700", mb: 1, ml: 1 }}>
                            Email Address
                        </Typography>
                        <TextField
                            fullWidth
                    ...
                    >
                        {loading ? <CircularProgress size={24} color="inherit" /> : "Sign In to Admin Panel"}
                    </Button>
                </form>

                <Box sx={{ mt: 4, textAlign: "center" }}>
                    <Link href="/" style={{ textDecoration: "none" }}>
                        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 1, color: "#A3AED0", "&:hover": { color: "#4318FF" }, transition: "0.2s" }}>
                            <ArrowBackIcon sx={{ fontSize: "1rem" }} />
                            <Typography variant="body2" fontWeight="700">Back to Main Site</Typography>
                        </Box>
                    </Link>
                </Box>
            </Paper>
